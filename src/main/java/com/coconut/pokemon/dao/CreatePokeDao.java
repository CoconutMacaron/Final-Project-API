...
@Component
@Slf4j
public class CreatePokeDao implements CreatePokeDaoInterface {
  ...
  public Pokemon createPokemon(Pokemon pokemon) {
    ...
    //formatter:off
    String sql = ""
        + "INSERT INTO pokemon (pokemon_id, name, type_1, type_2, region, legendary)"        
        + "VALUES (:pokemon_id, :name, :type_1, :type_2, :region, :legendary);";
    //formatter:on        
